...
namespace FlyzenApi.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpPut("timezone")]
        [Authorize]
        public async Task<ActionResult<UserDto>> UpdateTimezone(UpdateTimezoneRequest request) =>
            Ok(await _authService.UpdateTimezoneAsync(User.GetUserId(), request));

        [HttpPut("language")]
        [Authorize]
        public async Task<ActionResult<UserDto>> UpdateLanguage(UpdateLanguageRequest request) =>
            Ok(await _authService.UpdateLanguageAsync(User.GetUserId(), request));
